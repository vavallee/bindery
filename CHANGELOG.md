...
Forty entries from nineteen merged pull requests, and most of them are one piece
of work. Bindery had four separate ideas about what makes two pieces of text the
same, and they disagreed with each other. Library search folded only the 26 ASCII
